...
import com.xy.project.mapper.TeamMapper;
...
import com.xy.project.model.enums.TeamStatusEnum;
...
import com.xy.project.model.vo.UserVo;
            ...
            while (true) {
                if (lock.tryLock(0, -1, TimeUnit.MILLISECONDS)) {
                    ...
                    if (hasUserJoinTeam > 0) {
                        throw new BusinessException(ErrorCode.PARAMS_ERROR, "该用户已加入队伍");
                    }
                    //已加入队伍的人数
